...
addpath('E:\PandaSpaceSyn\DataSets\otherData\PascalS\HC\');% HC path
addpath('E:\PandaSpaceSyn\DataSets\otherData\PascalS\RC\'); % RC path
...
FusionResultDir = [rootpath 'MyResult\TopoFrameworkOnPascalNewFusionHCRC\'];
