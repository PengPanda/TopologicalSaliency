...
% for k=1:1
    ...
    %%
    [topoBgProb,bgWeight] = covertRBD2TopoPrior(noFrameImg,pixelList,colDistM, adjcMatrix, bdIds, clipVal, geoSigma);  %% my changes
    bgProb=topoBgProb;
    %%
    ...
    smapName=fullfile(RES, strcat(noSuffixName, 'RBD_topo.png'));
